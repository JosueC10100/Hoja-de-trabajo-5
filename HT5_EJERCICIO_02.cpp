...
#include<cstdlib>
using namespace std;
/*Una persona desea comprar entradas para un concierto que se realizará en la explanada de cierto lugar de la ciudad. El precio de la entrada varía según la zona 
elegida, así tenemos la lista de precios es la siguiente:
Zona	ID	Precio
VIP		V	350.00
Platea	P	130.00
Popular	E	 50.00

Adicionalmente los precios tendrán un descuento en función del número de entradas que se compren, así como si la persona que las adquiere es socio o no.
...
Descuento por ser socio
Es socio?	% de descuento
Si			8%
No.			0%
...
void menu(){
	...
	do{
		...
		if(option==1){
			int n,i=0;
			system("CLS");
			cout<<"Cuantas entradas adquirirá? "<<endl;
			cin>>n;
			for(i;i<n;i++){
				system("CLS");
				input();
...
void input(){
	...
	if(spot==1){
		...
		system("CLS");
		cout<<"Ingresar un dato válido"<<endl;
		system("PAUSE");
	}
	suma=suma+price;
	n=n+1;
